<template>
    <section class="bg-white max-w-6xl mx-auto px-8 py-4 lg:py-24">
        <div class="max-w-screen-md mx-auto mb-8 text-center lg:mb-12">
            <h2 class="mb-4 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white">Our  Services</h2>
            <p class="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">We offer a range of services designed to make notarization easy, secure, and convenient.</p>
        </div>
        <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
            ...
            <div v-for="index of 3"
                ...
                <div class="flex items-baseline justify-center my-8">
                    <span class="mr-2 text-5xl font-extrabold"><i class="fa-solid fa-peso-sign"></i>29</span>
